...
def gen_h2o_mask(attn_weights,heavy_budget_ratio=0.5,recent_budget_ratio=0.5):
    ...
    # mask_bottom = ones
    h2omask = torch.zeros_like(attn_weights, dtype=torch.bool)
    h2omask[~mask_bottom] = torch.finfo(attn_weights.dtype).min
    return h2omask
